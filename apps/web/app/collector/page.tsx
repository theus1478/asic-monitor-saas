...
export default function CollectorPage() {
  return <Shell><PageHeader title="Coletor local" description="Instale uma vez no computador principal de cada fazenda." action={<a className="button download-button" href="/downloads/ASICMonitorAgent.exe" download>⇣ Baixar para Windows</a>} />
    <section className="collector-hero card"><div><p className="eyebrow">ASIC MONITOR AGENT · V0.3</p><h2>Conecta sua rede local à nuvem com segurança</h2><p>O executável roda em segundo plano, consulta os IPs cadastrados, envia telemetria e aplica as trocas de pool solicitadas no painel. Nenhuma porta da fazenda precisa ficar exposta.</p><div className="collector-meta"><span>Windows 10/11</span><span>Sem interface</span><span>Atualização a cada 30s</span><span>Controle de pools</span></div></div><div className="collector-glyph">⇣</div></section>
